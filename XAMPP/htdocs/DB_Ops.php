...
try {
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadedFileName !== false) {
      $stmt = $conn->prepare("INSERT INTO Users (full_name, user_name, phone_number, whatsapp_number, addres, pasword, email, user_image, original_file_name) 
                VALUES (:fullname, :username, :phone_number, :whatsapp_number, :address, :password, :email, :user_image ,:original_file_name)");
